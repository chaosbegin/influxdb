...
pub use replication_client::GrpcReplicationClient; // Export the gRPC client

// Conditional export for mock client if test_utils feature is enabled
#[cfg(feature = "test_utils")]
pub use replication_client::mock::MockReplicationClient;
...
// --- Placeholder gRPC structs removed ---
